      ...
      <div className="w-96 mx-auto" style={{ scrollSnapType: 'x mandatory' }}>
        {carouselItems.map((item, index) => (
          <div key={index} style={{ display: currentSlide === index ? 'block' : 'none' }}>
            ...
            <div className="w-auto bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
              <img className="rounded-t-lg w-96 h-64" src={item.image} alt="" />
              ...
              <div className="absolute top-1/2 w-96 flex justify-between ">
